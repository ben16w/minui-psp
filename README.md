...
Deep sleep is supported on compatible devices. Click the power button to enter deep sleep. Click again to resume the game. To shut down, hold the power button for 2 seconds. **Note:** Shutdown does not save or resume your game and unsaved progress will be lost. For more information and known issues, see the [MinUI Power Control](https://github.com/ben16w/minui-power-control).
